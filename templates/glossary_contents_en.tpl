<div id="main_text">
	...
	<div class="g_text">
		<h3>Syllabus:</h3>
		<p>This is a document that outlines a course¡Çs lectures, assessment, and any academic regulations, and is very important for students who are currently choosing which courses to take. As well as being distributed in printed form, there are also electronic versions available on the web and through using each faculty¡Çs touchpanel.</p>
		<h3>Credit:</h3>
	...
	<div class="g_text">
		...
		<p>A program from MEXT of the same basic idea as the ¡È21st Century COE Program¡É, with the aim of promoting formation of internationally competitive universities, mainly helping internationally excellent research institutions to strengthen and enhance Japanese research institutions in order to foster world-leading creative talent. With this program, as with the ¡È21st Century COE Program¡É, Nagoya University has many qualifying departments and fields. For more information please visit <a href="http://www.jsps.go.jp/j-globalcoe/index.html">the Japan Society for the Promotion of Sciences (JSPS) website</a>.</p>
		...
		<h3>TEFS:</h3>
		<p>Techo-Frontier Seminars, labs-based lectures held every year in summer by Nagoya University¡Çs Engineering Department aimed at high-school students across the whole of the Aichi-Tokai area. For details please see<a href="http://www.echo.nuee.nagoya-u.ac.jp/tefs/">this website</a>.</p>
		<h3>Mathematics Agora:</h3>
		<p>Public lectures organized and held every year by Nagoya University¡Çs Graduate School of Mathematics, aimed at high-school students and their teachers. Details can be found at<a href="http://www.math.nagoya-u.ac.jp/ja/public/agora"> the Graduate School of Mathematics¡Ç website</a>.</p>
	<div id="akf"><h3>AFK Search:</h3>
		...
		<li><a href="http://libst1.nul.nagoya-u.ac.jp/eco/index.html" target="_blank">Eco-Collection</a>, a historical archive of flood control and Japan¡Çs largest rivers, conveys the historical relationship between nature and humanity in a real and up-to-date way with its ¡ÈDocument Tree House¡É, also contains a database of gathered manuscripts of Ito Keisuke, the godfather of modern Japanese botany.</li>
