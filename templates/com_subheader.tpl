...
*}
        {/if}
{else}
    {if $page_type != "summercamp" && $page_type != "nobel_interview" && $page_type != "open_campus_2015" && $page_type != "teacher" && $page_type != "romeclub" && $page_type != "specialtopics" && $page_type != "repository"}        <img src="./images/{$lang}/header_{$page_type}.jpg"
            alt="{/literal}{section name=n loop=$navi_list start=-1 max=1}{$navi_list[n].text}{/section}{literal}"> 
    {/if}
{/if}
...
{if $page_type != "sitemap" && $page_type != "topics_branches" && $page_type != "special" && $page_type != "topics2016" && $page_type != "topics2016engi" && $page_type != "topics2016agri" && $page_type != "topics2015sec" && $page_type != "topics2015" && $page_type != "topics2014" && $page_type != "topics2013"}
