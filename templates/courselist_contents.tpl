...
{foreach from=$deptlist_for_clist item="dept"}
	...
	<!-- 部局名 -->
	<a href="index.php?lang={$lang}&mode=course_list&page_type={$dept.department_abbr}"><img src="./images/t_clist_{$dept.department_abbr}.gif" alt="{$dept.department_name}" width="155" height="40"></a>
	</div>
