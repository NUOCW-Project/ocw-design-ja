<div id="topics2017_kajiwara">
  ...
  <div id="kajiwara_main">
    ...
    <div id="manu">
      ...
      <ul class="link">
        <li><a href="./index.php?lang=ja&mode=g&page_type=topics2017_kajiwara_1">測量実習、名古屋大学の遺跡を知る、報告会</a></li>
