<p align="right" margin="10px" ><a href="./index.php?lang=ja&mode=g&page_type=topics_branches">遊び体験のページへ戻る</a></p>
<div id="t">
<img src="./images/ja/topics2/lead3.png" id="top1" width="723" height="500" alt="ゲームに勝つためには，プレイヤー間の駆け引きに想像を膨らませて，戦略を練るということが必要となります。この授業では普段触れることのない海外のボードゲームを取り上げ，実際にプレイし，勝つための戦略を考え，皆で議論します。今回は、ocw学生サポーターが授業を体験してきました。授業概要：有田隆也教授「基礎セミナー - ボードゲームを究める」●開講部局：教養教育院●授業時間：2010年度後期木曜４限●対象者：文学部、情報文化学部（自然）、理学部、農学部、工学部、（II,III,IV系）●2単位、週１回全15回">
...
<ol><li class="p1"><span style="background-color:#ffffff">
事前に担当を決められた学生がゲームのルールを解説。</span></li></ol>
...
<ol start="2"><li class="p2">
<span style="background-color:#ffffff">グループにわかれてプレイ、中盤にグループ交代。</span>
</li></ol>
<p class="pi"><span style="background-color:#ffffff">
OCWサポーター市之瀬</span>
</p>
<ol start="3"><li class="p3">
<span style="background-color:#ffffff">担当の学生はプレイに参加せず、サポートや戦略の分析を行う。途中でグループを入れ替える。</span></li></ol>
</p>
...
<ol start="4"><li class="p4">
<span style="background-color:#ffffff">最後に先生がゲームの解説・まとめをする。</span></li></ol>
...
<div class="ia3">
<p>
<b>インタビュアー 市之瀬（以下、市）：「ボードゲームで遊ぶ」という授業をして、良かったことは何ですか？ </b>
</p>
<p>
...
<p>
有：今の学生の皆さんを見ていると、ただ“こんな人生になるんだろうな”という気持ちで、そこそこ成功して生きているように思います。彼らは“自分からこれをやりたい”というモチベーションが少ない。そして普通の授業では、学生からのレスポンスはほとんど無いという状態です。</p>
</div>
