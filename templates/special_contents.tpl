...
<img src="./images/ja/topics2/pagelink.png" alt="有田先生のページへ"> 

<img border="0" src="./images/ja/topics2/pagelink.png" alt="有田先生のページへ"  onMouseOver="this.src='./images/ja/topics2/pagelink_on.png'" onMouseOut="this src='./images/ja/topics2/pagelink.png'">
...
<p>
この授業ではではドイツのゲームを使っているのですが、ドイツには日本では考えられない文化があります。例えばドイツでは、人の家に行く時のお土産がボードゲームだったりする。</p>
</div>
...
<p>
今の学生の皆さんを見ていると、ただ“こんな人生になるんだろうな”という気持ちで、そこそこ成功して生きているように思います。彼らは“自分からこれをやりたい”というモチベーションが少ない。そして普通の授業では、学生からのレスポンスはほとんど無いという状態です。</p>
</div>
