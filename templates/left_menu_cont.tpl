...
{strip}
  ...
  <li class="{$basename}">
    ...
    {else}
      ...
      <a href="index.php?mode=course&id={$course_id}&page_type={$page.filename}{literal}&prev_mode={$smarty.get.mode}&prev_id={$smarty.get.id}&prev_page_type={$smarty.get.page_type}&lang={$smarty.get.lang}{/literal}"><img src="./images/dummy.gif" alt="{$page.page_name}"></a>{/if}
  </li>
