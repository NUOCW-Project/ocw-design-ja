...
<tr>
	...
	<form class="feedback" action="http://ocw.nagoya-u.jp/feedback.php" method="post">
	...
	<p class="feedback">ご意見をお聞かせください。このサイトに関する情報はいかがでしたか？</p>
		<input type="radio" name="" value="">とても参考になった<br></input>
		<input type="radio" name="" value="">参考になった</option><br>
		<input type="radio" name="" value="">やや参考になった</option><br>
		<input type="radio" name="" value="">どちらでもない</option><br>
		<input type="radio" name="" value="">参考にならなかった</option><br>

	<h2 class="feedback">*あなたは：（選択）</h2>
		<select name="" size="1" tabindex="0">
		<option value="" selected>▼こちらから選択してください</option>
		<option value="">名古屋大学の学生・院生</option>
		<option value="">その他の大学の学生・院生</option>
		<option value="">名大の教職員</option>
		<option value="">その他の教職員</option>
		<option value="">自主学習者</option>
		<option value="">受験生・高校生</option>
	...
	<p class="feedback">（ここにご記入いただいた内容を公開することはありません。また、原則お答えすることはできません。お問い合わせの場合は<a href="index.php?lang={$lang}&mode=general&page_type=inquiry">こちら</a>から。）</p>
