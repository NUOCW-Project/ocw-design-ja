...
<p class="comment">身近なものを物理的にとらえることを通じて、物理に関する固いイメージをなくいしてもらえたら、と思います。</p>
<img alt="前川浩隆" src="./images/ja/topics4/person/maekawa.png">
<p>ブーメランがどのように飛んでいるのかを考えたことがありますか？その仕組みには揚力という力とブーメランの「回転」がとても大きな働きをしています。ブーメランはなぜ落ちないのか？どうして手元へ戻ってくるのか？今回はブーメランの描く軌跡の理由を基礎的なところから説明していきたいと思います。また実際に紙でブーメラン作って飛ばしてみるので興味のある方はぜひブーメランを作りに来てください。 
</p>
...
<img art="森義治" src="./images/ja/topics4/person/mori.png">
<p>
...
<img art="安西高廣・塩田拓也" src="./images/ja/topics4/person/siota_anzai.png">
...
<img art="久保宏樹" src="./images/ja/topics4/person/kubo.png">
...
{flvplay path="rtmp://ms011.media.nagoya-u.ac.jp/video/S0001782/FLASH-FLV/20120312econophysics.flv"}
</p> 
</li>
<li id="detail6">
<h1>大学の数学って何？-広大なる世界への第一歩-</h1>
<p class="comment">新入生に数学を感じてもらえれば良い。</p>
<img art="小西正秀" src="./images/ja/topics4/person/konishi.png">
<p>皆さんにとって「数学」とはどういうものだったでしょうか。高校の数学が好きな人も嫌いな人も、得意な人も苦手な人もいるでしょう。ただ、大学からの数学は趣がガラリと変わります。ここでは学部三年次に制作するポスターを多数展示しています。新入生が一目見て理解できる代物ではありませんが、それでも充分に数学の世界を垣間見ることができます。今まで抱いてきた数学への思いを一旦忘れて、真っ白な心で数学の世界を眺め、その広さを感じて下さい。気になったことがあれば近くで暇そうにしている先輩に声を掛けて下さい。彼らは数学の世界の住民ですが、怖い人ではありません。どうぞお気軽に。</p>
</li>
<li id="detail7">
<h1>円の数学</h1>
<p class="comment">1年生はやる気に満ちあふれているので。その勢いをそのまま勉強にあててもらえれば。高校と大学に間をつなぐことを意識しました。
話していると、就職どうしよう、学科分属など相談を受けた。</p>
<img art="足立真訓" src="./images/ja/topics4/person/adachi.png">
<p>円は最も基本的な図形の一つで、紀元前から研究されてきた数学的対象です。みなさんも小学校の算数以来、中学校の初等幾何学や、高校の座標幾何学、三角関数など、円に親しんでこられたかと思います。大学で学ぶ数学でも、円について新しい側面を学ぶことになりますし、実は、円についてまだ分かっておらず、研究されている話題もまだまだあります。そんな中からいくつかのトピックをご紹介しようと思います。 </p>
</li>
<li id="detail8">
<h1>地球環境システム学への招待</h1>
...
<img art="片岡良輔" src="./images/ja/topics4/person/kataoka.png">
<p>新入生の皆さん、サイエンスの世界へようこそ。私たち地球化学講座は、地球・宇宙・環境に関する様々な事象について化学的な手法を用いて明らかにしようとしています。つまり、「地球を化学の目で見る」という姿勢で、サイエンスの世界を走り回っているってわけです。実験、データの整理、毎日がスリルの連続。今私たちが味わっているスリルについて、具体的な事例を交えてお伝えします。 </p>
</li>
<li id="detail10">
<h1>太陽地球環境研究所　研究所紹介</h1>
<p class="comment">太陽地球科学研究所について、もっと多くの方に知って頂けたら、と思っています。</p>
<img art="原拓也" src="./images/ja/topics4/person/hara.png">
<p>太陽地球環境研究所は，太陽表面から，宇宙空間，地球大気に渡る広大な領域を研究対象とし，太陽からやってくるエネルギーや物質がどのように伝わり，地球周辺にどのような影響を与えるかを主なテーマとして研究しています。本展示では，実際に私たちがどのような研究をしているかについて紹介したいと思います。新入生のみなさまに「手の届く宇宙」である，太陽地球系科学のおもしろさをお伝えできたらと思っています。</p>
</li>
<li id="detail11">
<h1>140年間探索されてきた花粉管誘引物質を発見！</h1>
<p class="comment">研究を紹介できる場がもらえてよかった。</p>
<img art="武内秀憲" src="./images/ja/topics4/person/takeuchi.png">
<p>植物の受精は、穀物生産など、人類にも密接にかかわる重要な現象です。古くからの多くの研究にも関わらず、植物の受精は神秘のヴェールに覆われるかのように、謎に包まれてきました。謎の現象の一つが、花粉管ガイダンスと呼ばれる仕組みです。めしべの先端で花粉から伸びだした花粉管は、迷うことなく、正確にめしべ内部にある卵細胞に到達します。私達の研究室では、卵細胞に隣接する助細胞から分泌される花粉管誘引物質を発見しました。本展示では、この謎の解明に至った研究をご紹介したいと思います。 </p>
</li>
<li id="detail12">
<h1>遊び・運動・学習による脳の活性化のしくみ</h1>
<p class="comment">私達と研究をぜひしてみたい学生を”大”募集中です！ </p>
<img art="山内康久" src="./images/ja/topics4/person/yamauchi.png">
<p>遊び道具や仲間の多い豊かな環境で育ったラットでは脳がよく発達する」というデータが1945年にRosenzweigらによって報告されました。それ以来サルまでの哺乳類において、適度な感覚刺激や運動が脳重量、神経細胞数、シナプス結合数を後天的に増やし、さらにストレスや疾患への耐性をも与えることが確立しました。この生命現象は比較的短期間で大きな脳と高い知性を獲得したヒトの進化の謎への手がかりを与えるだけでなく、その分子メカニズムを解明し、強化することで教育や医療への応用も期待されることから、広く注目を集めています。私たちは、興奮した神経細胞がGFP(クラゲの蛍光蛋白質）で光るようにデザインした遺伝子改変マウスや、感覚や運動の代わりに電気でピンポイント刺激した脳などを用いて、脳の活性化のしくみを探索しています。あなたもマウスと遊んだり彼らの光る脳を蛍光顕微鏡で観察したりしながら、自分の脳を活性化してみませんか。 </p>
</li>
