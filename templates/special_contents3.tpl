...
<li id="intro1">
    ...
    <hr>
    <p class="lead">
     法律は社会を観察するための一つの切り口です。この授業では、自分で選択した映画を題材とし、法律という視点で問題を捉えてい\
きます。また、発表・司会・ディベートの役割を通じて、自分の考えを主張していくことができます。 自己抑制的だった高校までの学習\
から、一歩踏み出す。六法全書の丸暗記ではない、法律問題の議論の楽しさがこの授業にはあります。
    </p>
