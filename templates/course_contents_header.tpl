  <div class="course_contents"><!-- 中核のボックス -->
    ...
    <img src="./images/2010/img/m01couesehome_hi.gif" id="couesehome_tag" 
	 ...
	 onMouseOut="this.src='./images/2010/img/m01couesehome_hi.gif'"><!--タグ画像「授業ホーム」--><img 
											    src="./images/2010/img/m02syllabus.gif" 
											    onMouseOver="this.src='./images/2010/img/m02syllabus_on.gif'" 
											    onMouseOut="this.src='./images/2010/img/m02syllabus.gif'"><!--タグ画像「シラバス」--><img 
																					src="./images/2010/img/m03resources.gif" 
