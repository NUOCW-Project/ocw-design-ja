...
<ul class="left_menu">
<!-- 授業一覧へのリンク -->
<li class="m00list"><a href="index.php?lang=ja&mode=course_list&page_type=all{if $smarty.get.display_mode == 'temp'}&display_mode=temp{/if}"><img src="./images/dummy.gif" alt="授業一覧"></a></li>
...
{strip}
  ...
  {else}<a href="index.php?lang=ja&mode=course_list&page_type={$dept.department_abbr}"><img src="./images/dummy.gif" alt="{$dept_name}"></a>
  {/if}
  </li>
{/strip}
