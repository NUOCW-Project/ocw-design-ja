  ...
  <div class="header" id="top"><!-- 最上部ヘッダー -->
    <div class="header_sub"><!-- 最上部ヘッダー可動域 -->
      <div class="header_button"><!-- 最上部ヘッダーのボタン部分 -->
        ...
        <img src="{$IMGDIR}/{$lang}/h01sitemap.gif" id="sitemap" 
        ...
        <img src="{$IMGDIR}/{$lang}/img/h02inquiry.gif" id="inquiry" 
        ...
        <img src="{$IMGDIR}/{$lang}/h03help.gif" id="help" 
        ...
        <div class="header_button_sub"><!-- 最上部ヘッダー部分を２つに分けた -->
          ...
          <div class="header_button_akf">
             <img src="{$IMGDIR}/{$lang}/akf.gif" id="akf" align="left"/>
