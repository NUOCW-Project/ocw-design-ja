...
<div id="movie">
  {if $course_info.vsyllabus_rtmp != ''}
    ...
    <iframe src="http://video.media.nagoya-u.ac.jp/pcsweb/contents-information.do?contentsCode={$course_info.vsyllabus_rtmp}#details_thumb_box" width="240" height="133" Frameborder="0" scrolling="no"></iframe>
