...
{* 名古屋大学公開講座と最終講義は講師紹介 *}
{if $course_info.department_abbr=='extension'|| $course_info.department_abbr=='fw2012' || 
...
{* 高校生公開講座はシラバスなし *}
{if $course_info.department_abbr!='extension' && $course_info.department_abbr!='sem' && $course_info.department_abbr!='fw2012' &&
