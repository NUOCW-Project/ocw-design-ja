...
{section name="bn_navi" loop=$id_end start=$id_start}
	{if $smarty.section.bn_navi.index != $bn_index}
	<a href="index.php?lang={$lang}&amp;mode=p&amp;page_type=backnumber&amp;id={$smarty.section.bn_navi.index}">{$smarty.section.bn_navi.index}</a>
