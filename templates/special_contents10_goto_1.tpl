<div id="topics2017_goto">
  <div id="topics2017_goto_top">
    <div id="topics2017_goto_header" alt="Be a TV Director! メディア研究・ビデオ制作を通したメディアリテラシーの獲得 (後藤明史先生)">
      <img id="topics2017_goto_icon" src="images/ja/topics10/goto/goto_header_icon.svg" alt="Be a TV Director! メディア研究・ビデオ制作を通したメディアリテラシーの獲得 (後藤明史先生)">
  ...
  <div id="goto_main">
    ...
    <img id="picture_yokomizo_1" src="images/ja/topics10/goto/goto_pic_1.jpg">
    <p class="image">熱心に大塚さんのお話に耳を傾ける学生たち</p>
    ...
    <img id="picture_yokomizo_1" src="images/ja/topics10/goto/goto_pic_2.jpg">
    <p class="image">学生たちに、番組テーマ設定のアドバイスを送る後藤先生</p>

    <p>
      最後の10 分は、学生たちで輪になって、テーマ設定に関する話し合いが行われました。学生たちは、お互いに言いたいことが言いやすいアットホームな雰囲気の中で、真剣かつ楽しく話し合いをしていました。
    </p>

    <img id="picture_yokomizo_1" src="images/ja/topics10/goto/goto_pic_3.jpg">
    <p class="image">番組テーマ設定について、輪になって話し合う学生たち</p>
