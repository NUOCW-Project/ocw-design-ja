...
<tr>
	...
	<p class="notfound">
	<a href="index.php?lang={literal}{$smarty.session.prev_lang}&mode={$smarty.session.prev_mode}&id={$smarty.session.prev_id}&page_type={$smarty.session.prev_page_type}{/literal}">1つ前のページに戻る</a>
    </p>
