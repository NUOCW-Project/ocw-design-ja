...
<tr>
  <td colspan="3">
<!-- バックナンバーへのリンク -->
<div class="pickup_to_bn"><a href="index.php?lang={$lang}&mode=pickup&page_type=backnumber&id=1"><img src="./images/bn.gif" width="70" height="25"></a></div>
  </td>
</tr>
<tr>
...
-->
  ...
  {/strip}
    <td class="pickup_img" rowspan="2">
      {if $pu.relation_id}<a href="index.php?mode=course&id={$pu.relation_id}"><img class="pickup_image" src="{$pu.relation_id}/{$pu.file_name}" alt="{$pu.title}" width="150"></a>
