...
<li id="intro1">
    ...
    <hr>
    <p class="lead">
     法律は社会を観察するための一つの切り口です。この授業では、自分で選択した映画を題材とし、法律という視点で問題を捉えていきます。 また、発表・司会・ディベートの役割を通じて、自分の考えを主張していくことができます。自己抑制的だった高校までの学習から、一歩踏み出す。六法全書の丸暗記ではない、法律問題の議論の楽しさがこの授業にはあります。</p>
...
<li id="intro2">
    ...
    <hr>
    <p class="lead">
    注目してほしいのはこの授業が医学部対象であるところです。また、理学部はもちろん、理系の学生のほとんどが物理学実験の授業を選択することができます。自分の手で物理学の実験をすることが医学部や他の学部の学生にとってどう役にたつのか、ぜひ講義ノートの「物理学実験ガイダンス」に目を通してみてください。</p>
...
<li id="intro4">
    ...
    <hr>
    <p class="lead">
    何気なく食べている野菜、肉、お米。何気なく飲んでいる牛乳、お茶。それらがどこからどのようにして私たちのもとへ届くのか、考えたことがありますか。この授業では私たちの生活を支える農業を実際に体験することで、現場の新鮮な知識を身につけることができます。また、学生が主体的に行動するため、研修を進路選択に活かせます。</p>
