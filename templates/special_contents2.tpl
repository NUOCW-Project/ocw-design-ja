...
<p class="lead">
<ol><li>
左欄の興味がある授業へポインタを移動させると、授業の説明が出てきます。
</li><li>クリックするとインタビュー記事が表示されます。
</li><li>もっと詳しく知りたかったら下の丸をクリック！授業の詳しい説明が読めます。
</li>
</ol>
</p>
...
<li id="intro3">
    ...
    <hr>
    <p class="lead">
    名古屋大学には１２００人を超える留学生がいます。 日本人はなぜそんなに漫画が好きなの？」<br>「地下鉄で眠っている人が多いのはなぜ？」 <br>
 留学生は日本に対するさまざまな疑問を持っています。この授業では、そのような疑問を留学生から引き出し、 その答えを留学生と在校生が一緒に考えることで、日本に対する理解や相互の理解を深めます。</p>
