<div id="contents">
<a href="./index.php?lang=ja&amp;mode=g&amp;page_type=about"><{$IMGDIR} src="../{$IMGDIR}/top/menu01.png" onMouseOver="this.src='../{$IMGDIR}/top/menu01_on.png'" onMouseout="this.src='../{$IMGDIR}/top/menu01.png'" class="menu0" /></a>
<a href="./index.php?lang=ja&amp;mode=g&amp;page_type=legal"><{$IMGDIR} src="../{$IMGDIR}/top/menu02.png" onMouseOver="this.src='../{$IMGDIR}/top/menu02_on.png'" onMouseout="this.src='../{$IMGDIR}/top/menu02.png'" class="menu0" /></a>
<a href="./index.php?lang=ja&amp;mode=g&amp;page_type=vsyllabus"><{$IMGDIR} src="../{$IMGDIR}/top/menu03.png" onMouseOver="this.src='../{$IMGDIR}/top/menu03_on.png'" onMouseout="this.src='../{$IMGDIR}/top/menu03.png'" class="menu0" /></a>
<div class="menu0"><a href="http://www.media.nagoya-u.ac.jp/sc/"><{$IMGDIR} src="../{$IMGDIR}/top/menu04.png" onMouseOver="this.src='../{$IMGDIR}/top/menu04_on.png'" onMouseout="this.src='../{$IMGDIR}/top/menu04.png'" /></a><p id="date"><b>2009. 10. 04UP</b></p></div>

<div id="sp_feature">
  <{$IMGDIR} src="../{$IMGDIR}/top/t_special.png" />
  <{$IMGDIR} src="../{$IMGDIR}/top/backno.png" class="jump" />
  <br />
  <{$IMGDIR} src="../{$IMGDIR}/redline.gif" class="line" />
  <br />
  <{$IMGDIR} src="../{$IMGDIR}/d_sp_feature.JPG" /><!-- 画像「季節の講義　メッセージ」ダミー -->
</div> <!-- "sp_feature" end -->
    
<div id="greeting">
  <b>ごあいさつ<br />
  <{$IMGDIR} src="../{$IMGDIR}/d_yamamoto.JPG" id="yamamoto" />
...
<div class="topics"><!-- ボックス「アクセスランキング」 -->
  <{$IMGDIR} src="../{$IMGDIR}/top/t_ranking.png" class="subheading" />
  <br />
  <{$IMGDIR} src="../{$IMGDIR}/top/dot.png" />
  <dl id="ranking">
  <dt>順位 講義名</dt>
      <dd>教員名</dd>
...
<div class="topics"><!-- ボックス「お知らせ」-->
  <{$IMGDIR} src="../{$IMGDIR}/top/t_news.png" class="subheading" />
  <{$IMGDIR} src="../{$IMGDIR}/top/backno.png" class="jump" />
  <br />
  <{$IMGDIR} src="../{$IMGDIR}/top/dot.png" />
    <dl class="notice">
...
<div class="topics"><!-- ボックス「プレスリリース」-->
  <{$IMGDIR} src="../{$IMGDIR}/top/t_release.png" class="subheading" />
      <{$IMGDIR} src="../{$IMGDIR}/top/backno.png" class="jump" />
  <br />
  <{$IMGDIR} src="../{$IMGDIR}/top/dot.png" />
    <dl class="notice">
