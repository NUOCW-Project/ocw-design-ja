...
<tr>
	...
	<li><a href="http://jocw.jp/"><img src="./images/logo_jocw.gif" alt="JOCW"></a></li>
	<li><a href="http://ocw.mit.edu/"><img src="./images/logo_mit.gif" alt="MIT OPEN COURSE WARE"></a></li>
	<li><a href="index.php?lang={$lang}&mode=g&page_type=vsyllabus"><img src="./images/b_video.jpg" alt="1分間授業紹介"></a></li>
	<li><a href="index.php?lang={$lang}&mode=g&page_type=feedback&ref_lang={$lang}&ref_mode=g&ref_id=&ref_page_type=top"><img src="./images/b_feedback.jpg" alt="Feedback"></a><li>
	</ul>
