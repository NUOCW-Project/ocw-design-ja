...
<div id="header_for_top">
	...
	<div id="menu">	
		...
		<div class="menu0"><a href="http://www.media.nagoya-u.ac.jp/sc/" target="_brank"><img src="./images/{$lang}/menu04.png" onMouseOver="this.src='./images/{$lang}/menu04_on.png'" onMouseout="this.src='./images/{$lang}/menu04.png'" /></a><p id="date"><b>{literal}{include file="common/studiochannel.tpl"}{/literal}UP</b></p></div>
	</div><!-- "menu" end 
