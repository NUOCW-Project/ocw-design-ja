...
<tr>
	...
	<a href="{$smarty.const.PUBLIC_SCRIPT_NAME}&lang={$lang}&mode=pickup&page_type=backnumber&id=1"><img src="./images/bn.gif" alt="バックナンバー"></a>
	</p>
	...
	{assign var="pu" value=$pickup_list[0]}{* TOPでは最初の1個だけ *}
		...
		<tr>
			...
			<td class="pickup_summ_top">
				{if $pu.relation_id}
				<a href="{$smarty.const.PUBLIC_SCRIPT_NAME}&mode=course&id={$pu.relation_id}"><img class="pickup_image" src="{$smarty.const.PUBLIC_FILES_WEB_PATH}{$pu.relation_id}/{$pu.file_name}" alt="" width="150" height="108"></a>
				{else}
	...
	<p class="pickup_more">
	<a href="{$smarty.const.PUBLIC_SCRIPT_NAME}&lang={$lang}&mode=pickup&page_type=new">more...</a>
	</p>
	...
	<a href="{$smarty.const.PUBLIC_SCRIPT_NAME}&lang={$lang}&mode=general&page_type=topics_list"><img src="images/t_topic_list.jpg" alt="TOPICS一覧"></a>
	</p>
...
<tr>
	...
	<a href="{$smarty.const.PUBLIC_SCRIPT_NAME}&lang={$lang}&mode=general&page_type=welcome"><img src="./images/pic_sugi.jpg" alt="OCW委員長"></a>
	</div>
...
<tr>
	...
	<li class="big_button"><a href="{$smarty.const.PUBLIC_SCRIPT_NAME}&lang={$lang}&mode=general&page_type=vsyllabus"><img src="./images/b_video.jpg" alt="1分間授業紹介"></a></li>
	<li class="big_button"><a href="{$smarty.const.PUBLIC_SCRIPT_NAME}&lang={$lang}&mode=general&page_type=feedback"><img src="./images/b_feedback.jpg" alt="Feedback"></a><li>
	</ul>
