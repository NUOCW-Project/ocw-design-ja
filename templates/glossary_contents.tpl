...
<tr>
	...
	<table class="center_contents" width="600">
		...
		<td class="left">
			...
			<p>各学部に共通する基礎教育及び教養教育を全学共通教育で行う組織。他大学の教養部にあたる。</p>
			<p><span class="b">全学教養科目</span></p>
			<p>新入生を大学教育に導入し、自立した学習能力を身につけるとともに、文・理に共通した基礎的学力や技能を養う科目。</p>
		...
		<td class="left">
			...
			<p>21世紀COEプログラム」の基本的な考え方を継承しつつ、我が国の大学院の教育研究機能を一層充実・強化し、世界をリードする創造的な人材育成を図るため、国際的に卓越した教育研究拠点の形成を重点的に支援し、国際競争力のある大学づくりを推進することを目的とする文部科学省による事業。「21世紀COEプログラム」同様、名古屋大学は複数の分野でこのプログラムの拠点となっている。</p>
			<p><span class="b">21世紀COEプログラム</span></p>
			<p>「大学の構造改革の方針」(平成13年6月)に基づき、平成14年度から文部科学省の事業（研究拠点形成費等補助金）として措置された教育プログラム。名古屋大学は複数の分野でこのプログラムの拠点となっている。</p>
			...
			<p>名古屋大学工学部が、愛知県下を中心とする東海地区の高校生を対象として毎年夏に開催している実験教室（テクノフロンティアセミナー）。</p>
