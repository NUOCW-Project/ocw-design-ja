<div id="topics2017_miyata">
  ...
  <div id="miyata_main">
    ...
    <div class="script">
      この講義では、主に2つのテーマを掲げて観察・発表を行います。10月中旬～ 11月下旬までは第1 のテーマとして、「コオロギの組織観察」に取り組みました。学生は「脳神経運動系」「循環系」「呼吸系」「消化系」「泌尿生殖系」それぞれの部位の観察を担当する5 つの班に分かれて解剖・観察を行い、観察から得られた知見及び考察を発表会で発表しました。<br>
