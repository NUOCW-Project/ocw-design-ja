...
<tr>
	...
	<h1 class="welcome">Welcome to Nagoya University OpenCourseWare (NU OCW)</h1>
	...
	<a href="http://ms013.media.nagoya-u.ac.jp/vdb_contents/video/streams/_definst_/S0000680/FLASH-FLV/index.html" title="{if $lang=='ja'}1分間OCW紹介{else}1 minuite introduction of OCW{/if}"><img src="./images/{$lang}/b_video_ocw.jpg" alt="{if $lang=='ja'}1分間OCW紹介{else}1 minuite introduction of OCW{/if}" width="133" height="75"></a>
	</div>
