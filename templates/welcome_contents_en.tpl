...
<tr>
	...
	<a href="http://vdbserv.media.nagoya-u.ac.jp/ramgen/vod//OWE/00024521.rm?autostart=true" title="{if $lang=='ja'}1分間OCW紹介{else}1 minuite introduction of OCW{/if}"><img src="./images/{$lang}/b_video_ocw.jpg" alt="{if $lang=='ja'}1分間OCW紹介{else}1 minuite introduction of OCW{/if}" width="133" height="75"></a>
	</div>
