...
<li><a href="./courselist.php?lang={$lang}&amp;mode=l&amp;page_type=all">
   <img src="./images/ja/courselist.jpg" alt="{if $lang=="ja"}授業一覧から探す{/if}"
     onMouseOver="this.src='./images/ja/courselist_on.jpg'"
	   onMouseOut="this.src='./images/ja/courselist.jpg'"></a><!-- class"header_image"から移動 -->
<!-- 各学部ページへのリンクリスト -->
{literal}
{strip}
