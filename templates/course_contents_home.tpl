	...
	<div class="course_contents"><!-- コンテンツセル開始 -->
        ...
        <tr>
                ...
                <td class="td_contents_gray">
                	...
                	<p class="course_home_b">
					  <a href="{$course_info.vsyllabus}" title="1分間授業紹介（ビデオ）"><img src="./images/b_video.jpg" alt="1分間授業紹介（ビデオ）" width="120" height="73"></a>
					</p>
					{/if}

					<ul class="course_home_recommended">
					{if $course_info.wg_recommended eq "t"}<li><img src="./images/nominate_ocw.jpg" alt="OCW WG 推薦" width="120" height="28"></li>{/if}
					{if $course_info.dept_recommended eq "t"}<li><img src="./images/nominate_dep.jpg" alt="部局長推薦" width="120" height="28"></li>{/if}
					</ul>
					<!-- コンテンツセル終了 -->
                	</div>
                </td>
