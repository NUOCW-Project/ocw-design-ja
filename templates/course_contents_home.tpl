...
<tr>
	...
	<div class="course_contents"><!-- コンテンツセル開始 -->
        ...
        <tr>
                ...
                {else}
                    ...
                    <p class="course_home_i"><span class="i">Lectures:</span><br>
                                             {$course_info.lectures|nl2br|strip}
                    </p>

                	<p class="course_home_b">Class is for:</p>
                	<p class="course_home">{$course_info.class_is_for_en|nl2br|strip}</p>
      ...
      {if $course_info.vsyllabus_Flash}
