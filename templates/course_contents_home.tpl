	...
	<div class="course_contents"><!-- コンテンツセル開始 -->
        ...
        <tr>
                ...
                {/if}
                	...
                	<p class="course_home_b">
					  <a href="{$course_info.vsyllabus}" title="1分間授業紹介（ビデオ）"><img src="./images/{$lang}/b_video_link.jpg" alt="1分間授業紹介（ビデオ）" width="120" height="68"></a>
					</p>
					{/if}

					<ul class="course_home_recommended">
					{if $course_info.wg_recommended eq "t"}<li><img src="./images/{$lang}/nominate_ocw.jpg" alt="OCW WG 推薦" width="120" height="29"></li>{/if}
					{if $course_info.dept_recommended eq "t"}<li><img src="./images/{$lang}/nominate_dep.jpg" alt="部局長推薦" width="120" height="29"></li>{/if}
					</ul>
					<!-- コンテンツセル終了 -->
                	</div>
                </td>
