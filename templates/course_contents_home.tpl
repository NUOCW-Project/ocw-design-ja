	...
	<div class="course_contents"><!-- コンテンツセル開始 -->
        ...
        <tr>
                ...
                {/if}
					...
					{if $course_info.wg_recommended eq "t"}<li><img src="./images/{$lang}/nominate_ocw.jpg" alt="{if $lang=='ja'}OCW WG 推薦{else}This course has recommendation by OCW WG.{/if}" width="120" height="29"></li>{/if}
					{if $course_info.dept_recommended eq "t"}<li><img src="./images/{$lang}/nominate_dep.jpg" alt="{if $lang=='ja'}部局長推薦{else}This course has recommendation by the head of department.{/if}" width="120" height="29"></li>{/if}
					</ul>
					<!-- コンテンツセル終了 -->
                	</div>
                </td>
