...
<tr>
 ...
 <a href="{$course_info.vsyllabus_Real}" title="一分間授業紹介のRealVideoが再生されます"><img src="./images/common/b_video_r.jpg" alt="RealVideo" width="120" height="20"></a> 
<a href="{$course_info.vsyllabus_Flash}" title="一分間授業紹介のFlashVideoが再生されます" target="_blank"><img src="./images/common/b_video_f.jpg" alt="FlashVideo" width="120" height="24"></a>
 ...
 <a href="{$course_info.vsyllabus_Real}" title="Click to play RealVideo Player"><img src="./images/common/b_video_r.jpg" alt="RealVideo" width="120" height="20"></a> 
