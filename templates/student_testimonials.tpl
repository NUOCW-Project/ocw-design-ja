...
<div id="list_box">
  ...
  <div id="theme1" class="theme_box">
    ...
    <table class="list_table">
      ...
      <tr class="odd_row">
        <td><a href="javascript:SwitchFlash('top_video', 'rtmp://ms011.media.nagoya-u.ac.jp/video/S0001589/FLASH-FLV/ryugaku_suki.flv', 'japanese')"><img src="./images/common/student/v_about_japan01.png"/></a></td>
