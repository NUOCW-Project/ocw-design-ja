...
<!-- 画面上部の最も大きな要素 -->
  <div id="interview_video_frame">
    ...
    <object classid="clsid:D27CDB6E- AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="300" height="270">
    ...
    <embed src="./player.swf" FlashVars="FLV_URL=rtmp://ms011.media.nagoya-u.ac.jp/video/S0001599/FLASH-FLV/ryugaku_kanjita02.flv" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" wmode="transparent" width="300" height="270"></embed>
    </object>
    </div>
  </div>
</div>
...
<div id="theme_tub">
  <div class="tub_button_left">
    <a href="javascript:seltab('theme', 5, 1)" onClick="this.style.borderColor='#888888'"><img src="./images/common/student/title01.png" alt="about japan"></a>
  </div>
