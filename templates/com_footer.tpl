<!-- フッター -->
<div class="footer">
<a href="http://www.cshe.nagoya-u.ac.jp/stips/" target="_blank"><img src="./images/common/f_studytips.gif" width="100" height="25" alt="{if $lang=='ja'}名古屋大学新入生のためのスタディティップス{else}Study Tips for freshmen{/if}"></a>
